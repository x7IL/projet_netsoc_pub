            ...
            if ($ID_user!=NULL) {
                ...
                <?php
                    ...
                    if ($com["username_destinataire"]){
                        ?>
                        <b style=" max-width: 99%; word-wrap: break-word; "><?=$com['username_source']; ?><i style="opacity: 0.5;"> pour </i><?=$com["username_destinataire"]; ?> </b> <i style="opacity: 0.5;"><?=$com["post_date"]; ?></i><p style="font-size: 1.2em; margin-bottom: 0  max-width: 99%; word-wrap: break-word; "><?=$com["post"]; ?></p>
                        <?php
                    }
                    else{
                        ?>
                        <b style=" max-width: 99%; word-wrap: break-word; "><?=$com['username_source']; ?> </b> <i style="opacity: 0.5;"><?=$com["post_date"]; ?></i><p style="font-size: 1.2em; margin-bottom: 0  max-width: 99%; word-wrap: break-word; "><?=$com["post"]; ?></p>
                        <?php
                    }
